...
# This loop clears out ALL existing datasets (start with 0MB of DB usage)
...
# Master dataset to hold our final 390 images
...
main_dataset.export(
    export_dir=raw_dir, dataset_type=fo.types.ImageDirectory, overwrite=True
)
